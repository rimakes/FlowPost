...
const DraftModal = ({accountLinked ,setIsVoiceModalOpen}: props) => {
  return (
    <>
      {!accountLinked ? (
          ...
          <div>
            <div className='overflow-y-auto max-h-[80vh] lg:max-h-[80vh]'>
              <div className='relative gap-4 columns-1 md:columns-2 sm:gap-6 first:mt-1'>
                <div className='overflow-hidden transition-all duration-150 bg-white border border-gray-200 shadow-xs rounded-xl hover:shadow-md hover:-translate-y-1'>
                ...
                <div className='mt-4 overflow-hidden transition-all duration-150 bg-white border border-gray-200 shadow-xs rounded-xl hover:shadow-md hover:-translate-y-1'>
                  <div className='px-4 py-5 space-y-6 sm:p-6'>
                    <p className='text-base font-normal text-gray-900'></p>
                    <hr className='border-gray-200' />
                    <button
