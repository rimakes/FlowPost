    ...
    <div className='flex items-center justify-center -space-x-2'>
        {avatarData.map((item, idx) => {
            return (
                <Avatar
                    key={idx}
                    className='flex h-10 w-10 items-center justify-center overflow-hidden rounded-full border-2 border-white'
                >
                    <AvatarImage
                        src={item.imgURL}
        ...
        <p className='translate-x-5 text-sm font-medium text-gray-500'>
            Join 5.000+ users
        </p>
    </div>
);
