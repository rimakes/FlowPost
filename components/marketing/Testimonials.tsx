            ...
            <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
                <div className='flex flex-col items-center'>
                    <div className='text-center'>
                        <h2 className='text-base-content mb-4 text-3xl font-bold sm:text-4xl xl:text-5xl'>
                            Quienes ya nos han probado opinan
                        </h2>
                        <p className='text-secondary-content text-lg font-medium'>
                            Descubre una nueva forma de crear contenido
                        </p>
                    </div>
